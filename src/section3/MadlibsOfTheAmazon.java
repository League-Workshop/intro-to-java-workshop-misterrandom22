...
String place=JOptionPane.showInputDialog("place");
		...
		String sentence="Piranhas are more "+adjective+" durng the day,so cross the river at night. Piranhas are atracted to fresh "+liquid+" and will most likely take a bite of your "+bodypart+" if you "+verb+". Whatever you do, if you have an open wound,try to find your way back to "+place+". good luck";		
